```
ubuntu@ip-10-0-0-12:~/anaconda2$ conda info
Current conda install:
    ...
    conda-build version : 2.0.6
       ...
       root environment : /home/ubuntu/anaconda2  (writable)
    default environment : /home/ubuntu/anaconda2
...
```
```
ubuntu@ip-10-0-0-12:~/anaconda2$ conda list
